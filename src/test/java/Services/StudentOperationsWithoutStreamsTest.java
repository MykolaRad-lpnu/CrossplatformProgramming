...
class StudentOperationsWithoutStreamsTest {

    private StudentOperationsWithoutStreams studentOperations;
    private List<Student> students;

    @BeforeEach
    void setUp() {
        studentOperations = new StudentOperationsWithoutStreams();
